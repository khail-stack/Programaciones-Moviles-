...
import com.example.almacenapp.activities.ui.login.LoginActivity;
...
public class RegisterUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagePreview = findViewById(R.id.imagen_user_preview);
        usernameInput = findViewById(R.id.username_input);
        passwordInput = findViewById(R.id.password_input);
        nombresInput = findViewById(R.id.nombres_input);
    ...
    public void takePictureUser(View view) {
        try {
    ...
    public void callRegisterUser(View view) {
        ...
        if (username.isEmpty() || password.isEmpty() || nombres.isEmpty() || correo.isEmpty()) {
        ...
        if (mediaFileUri == null) {
            ...
            call = service.createUsuario(username, password, nombres, correo);
        } else {
            ...
            call = service.createUsuarioWithImage(usernamePart, passwordPart, nombresPart, correoPart ,imagenPart);
            ...
            public void onResponse(Call<ResponseMessage> call, Response<ResponseMessage> response) {
                try {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        Toast.makeText(RegisterUser.this, responseMessage.getMessage(), Toast.LENGTH_LONG).show();
                        finish();
